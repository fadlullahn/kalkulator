...
public class ChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webViewChart.loadUrl("https://kalkulator.fadlullahnft.com/index.php"); // Ubah sesuai dengan lokasi file HTML Anda
        ...
        btnShowWebViewTambah.setOnClickListener(v -> {
            if (!webViewTambahVisible) {
                ...
                webViewTambah.loadUrl("https://kalkulator.fadlullahnft.com/index2.php"); // Load URL untuk WebView Tambahan
        ...
        btnShowWebViewData.setOnClickListener(v -> {
            if (!webViewDataVisible) {
                ...
                webViewData.loadUrl("https://kalkulator.fadlullahnft.com/tampildata.php"); // Load URL untuk WebView Data
